...
public interface AccountRepository extends JpaRepository<AccountEntity, Integer> {
    ...
    @Query(value = "SELECT a.Id AS AccountId, a.Username, a.Password, ui.FullName, ui.Avatar, r.Name as Role, ui.DefaultPayment, ui.AccountBalance, ui.AccountTurn, a.Status " +
            "FROM Account a " +
            "         LEFT JOIN UserInfo ui " +
            "                   ON a.Id = ui.AccountId " +
            "         JOIN Role r " +
